...
WEAPONS={
    "fire":Weapon("fire","烈火",Quality.COMMON,205,150,36,24,18,20,50,"高攻击，地面破坏小",80,1),
    "true_fire":Weapon("true_fire","真·烈火",Quality.TRUE,205,250,60,40,30,20,50,"攻击大幅提升",350,5,crit_dmg_bonus=0.05),
    "ext_fire":Weapon("ext_fire","极·烈火",Quality.EXTREME,225,275,66,44,33,20,50,"极致攻击力",800,12,crit_dmg_bonus=0.1),
    "god_fire":Weapon("god_fire","神·烈火焚天",Quality.DIVINE,250,320,75,50,40,25,55,"焚尽万物的神焰之炮",2000,20,crit_dmg_bonus=0.15),
    "boom":Weapon("boom","轰天",Quality.COMMON,200,24,150,18,36,55,70,"高防御，适合抛射",80,1,hp_bonus=30),
    "true_boom":Weapon("true_boom","真·轰天",Quality.TRUE,200,40,250,30,60,55,70,"防御极大幅提升",350,5,hp_bonus=60),
    "ext_boom":Weapon("ext_boom","极·轰天",Quality.EXTREME,220,44,275,33,66,55,70,"铜墙铁壁",800,12,hp_bonus=100),
    "god_boom":Weapon("god_boom","神·不灭轰天",Quality.DIVINE,245,50,320,38,75,60,75,"永不陷落的要塞之炮",2000,20,hp_bonus=150),
    "wind":Weapon("wind","神风",Quality.COMMON,200,36,18,150,24,15,50,"速度极快，先手优势",80,1),
    "true_wind":Weapon("true_wind","真·神风",Quality.TRUE,200,60,30,250,40,15,50,"疾风迅雷",350,5),
    "ext_wind":Weapon("ext_wind","极·神风",Quality.EXTREME,220,66,33,275,44,15,50,"快到看不清",800,12),
    "god_wind":Weapon("god_wind","神·风行者",Quality.DIVINE,245,75,38,320,50,20,55,"驾驭风暴的神速之炮",2000,20),
    "lightning":Weapon("lightning","雷霆",Quality.COMMON,200,18,24,36,150,20,55,"高幸运，暴击率高",80,1,crit_dmg_bonus=0.1),
    "true_lightning":Weapon("true_lightning","真·雷霆",Quality.TRUE,200,30,40,60,250,25,60,"幸运大幅提升",350,5,crit_dmg_bonus=0.15),
    "ext_lightning":Weapon("ext_lightning","极·雷霆",Quality.EXTREME,220,33,44,66,275,25,60,"暴击之王",800,12,crit_dmg_bonus=0.2),
    "god_lightning":Weapon("god_lightning","神·万钧雷霆",Quality.DIVINE,245,40,50,75,320,30,65,"召唤天雷的神罚之炮",2000,20,crit_dmg_bonus=0.3),
    "sima":Weapon("sima","司马砸缸",Quality.COMMON,200,180,130,30,40,20,65,"攻防兼备",100,1),
    "ext_sima":Weapon("ext_sima","极·司马砸缸",Quality.EXTREME,220,198,143,33,44,20,65,"完全体司马",600,10),
    "tv":Weapon("tv","黑白家电",Quality.COMMON,200,95,95,95,95,50,70,"四项全能",120,3),
    "ext_tv":Weapon("ext_tv","极·黑白家电",Quality.EXTREME,220,104,105,104,105,50,70,"完美均衡",650,10),
    "medkit":Weapon("medkit","医用工具箱",Quality.COMMON,200,130,30,180,40,15,60,"敏捷型",100,1),
    "ext_medkit":Weapon("ext_medkit","极·医用工具箱",Quality.EXTREME,220,143,33,198,44,15,60,"手术刀般精准",600,10),
    "plunger":Weapon("plunger","畅通利器",Quality.COMMON,200,40,180,30,130,30,65,"高防高运",90,2),
    "ext_plunger":Weapon("ext_plunger","极·畅通利器",Quality.EXTREME,220,44,188,33,143,30,65,"马桶塞终极形态",600,10),
    "fruit":Weapon("fruit","牛顿水果篮",Quality.COMMON,200,40,30,130,180,20,65,"高幸运高敏捷",90,2,crit_dmg_bonus=0.05),
    "ext_fruit":Weapon("ext_fruit","极·牛顿水果篮",Quality.EXTREME,220,44,33,143,198,20,65,"万有引力之篮",600,10,crit_dmg_bonus=0.1),
    "ancient_spear":Weapon("ancient_spear","远古竹枪",Quality.DIVINE,242,145,25,145,145,15,65,"远古流传的神秘竹枪",1500,15,crit_dmg_bonus=0.1),
    "minotaur":Weapon("minotaur","牛头怪",Quality.DIVINE,242,145,145,145,25,15,65,"牛头人战神的巨炮",1500,15,hp_bonus=80),
    "boomerang":Weapon("boomerang","爱心回力标",Quality.DIVINE,242,25,145,145,145,15,65,"爱之回力标",1500,15,hp_bonus=80),
    "legend_boom":Weapon("legend_boom","真·远古轰天",Quality.LEGEND,260,60,350,45,80,60,80,"轰天最终形态",3500,25,hp_bonus=200,crit_dmg_bonus=0.05),
    "legend_fire":Weapon("legend_fire","真·灭世烈火",Quality.LEGEND,265,350,60,50,45,25,60,"烈火最终形态",3500,25,crit_dmg_bonus=0.25),
    # ═══ 8把屌炸天副本武器 ═══
    "thunder_judge":Weapon("thunder_judge","雷霆审判炮",Quality.MYTHIC,280,200,80,60,100,20,55,"命中后追加电击⚡，造成30%额外伤害",0,20,crit_dmg_bonus=0.2,icon="⚡",special_effect="chain_lightning",accuracy_bonus=-0.08,family="thunder_cannon",weapon_type="heavy",pit_radius=58,pit_depth=28),
    "abyss_crossbow":Weapon("abyss_crossbow","深海龙息弩",Quality.MYTHIC,230,160,90,100,80,30,65,"命中后附加2回合「潮蚀」持续伤害🌊",0,18,hp_bonus=40,icon="🌊",special_effect="tide_erosion",family="abyss_cannon",weapon_type="dot",pit_radius=28,pit_depth=15),
    "blackhole_cannon":Weapon("blackhole_cannon","黑洞重力炮",Quality.MYTHIC,200,120,120,70,130,35,80,"命中点生成引力场🌀，拉扯敌人",0,22,hp_bonus=60,icon="🌀",special_effect="gravity_well",family="gravity_cannon",weapon_type="control",pit_radius=52,pit_depth=24),
    "seraphim_railgun":Weapon("seraphim_railgun","炽天使轨道炮",Quality.MYTHIC,300,280,40,50,60,10,40,"弹道极直·暴击追加光束✨ 坑极小",0,25,crit_dmg_bonus=0.35,icon="✨",special_effect="beam_strike",accuracy_bonus=0.2,family="railgun",weapon_type="sniper",pit_radius=20,pit_depth=10),
    "chaos_dice":Weapon("chaos_dice","混沌骰子发射器",Quality.MYTHIC,220,150,70,90,180,25,55,"随机触发燃烧🔥/冰冻❄️/暴击💥/回血💚",0,20,crit_dmg_bonus=0.15,icon="🎲",special_effect="random_chaos",family="chaos_cannon",weapon_type="standard",pit_radius=44,pit_depth=20),
    "mecha_fist":Weapon("mecha_fist","远古机甲拳套炮",Quality.LEGEND,260,250,60,40,50,15,50,"近距离伤害+40%·远距衰减-30%🤖",0,18,hp_bonus=50,icon="🤖",special_effect="close_combat",family="mecha_cannon",weapon_type="heavy",pit_radius=65,pit_depth=28),
    "eclipse_scythe":Weapon("eclipse_scythe","月蚀镰刃炮",Quality.MYTHIC,210,130,80,100,150,30,60,"伤害25%转化回血🌙·坑小续航强",0,22,hp_bonus=50,icon="🌙",special_effect="life_steal",family="vampire_cannon",weapon_type="dot",pit_radius=32,pit_depth=15),
    "godpunish_missile":Weapon("godpunish_missile","神罚多重导弹",Quality.MYTHIC,250,180,50,70,90,20,45,"一次3枚导弹🚀每枚45%伤害·单坑极小",0,23,crit_dmg_bonus=0.1,icon="🚀",special_effect="multi_missile",family="missile_cannon",weapon_type="multi",pit_radius=22,pit_depth=10,projectile_count=3),
    # ═══ 魔罐限定武器 ═══
    "true_minotaur":Weapon("true_minotaur","真·牛头怪",Quality.LEGEND,280,280,120,80,60,20,60,"近距命中追加冲撞伤害🐂·坑中等偏大",0,20,hp_bonus=80,icon="🐂",special_effect="charge_bonus",family="beast_cannon",weapon_type="heavy",pit_radius=60,pit_depth=28),
    "true_spear":Weapon("true_spear","真·远古竹枪",Quality.LEGEND,270,200,40,160,140,15,50,"弹道极稳·命中穿透护盾🎋·坑极小",0,20,crit_dmg_bonus=0.2,icon="🎋",special_effect="armor_pierce",family="ancient_cannon",weapon_type="sniper",pit_radius=22,pit_depth=10,accuracy_bonus=0.25),
    "true_boomerang":Weapon("true_boomerang","真·爱心回力标",Quality.LEGEND,240,150,100,120,130,25,55,"命中后回旋追加伤害💕·伤害25%转回血",0,20,hp_bonus=50,icon="💕",special_effect="boomerang_heal",family="love_cannon",weapon_type="control",pit_radius=40,pit_depth=18),
    "angel_gift":Weapon("angel_gift","真·天使之赐",Quality.LEGEND,220,120,140,100,160,30,60,"攻击后概率恢复生命🪽·获得护盾",0,22,hp_bonus=100,icon="🪽",special_effect="angel_heal",family="angel_cannon",weapon_type="dot",pit_radius=30,pit_depth=14),
}
# 非传说/神话武器(可在副本掉落)
